...
void SystemClock_Config(void)
{
  ...
  LL_SetSystemCoreClock(320000000);
...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(ARD_A0_GPIO_Port, &GPIO_InitStruct);

  LL_SYSCFG_OpenAnalogSwitch(LL_SYSCFG_ANALOG_SWITCH_PA1|LL_SYSCFG_ANALOG_SWITCH_PA0);
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC1, LL_ADC_CHANNEL_10, LL_ADC_SAMPLINGTIME_32CYCLES_5);
...
void MX_ADC3_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ARD_A1_GPIO_Port, &GPIO_InitStruct);
  ...
  */
  ...
  ADC_CommonInitStruct.CommonClock = LL_ADC_CLOCK_ASYNC_DIV4;
  ADC_CommonInitStruct.Multimode = LL_ADC_MULTI_INDEPENDENT;
  ADC_CommonInitStruct.MultiDMATransfer = DISABLE;
  ...
  */
  ...
  LL_ADC_SetChannelSamplingTime(ADC3, LL_ADC_CHANNEL_0, LL_ADC_SAMPLINGTIME_ADC3_2CYCLES_5);
...
void MX_DAC1_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(DAC1_OUT2_GPIO_Port, &GPIO_InitStruct);
...
void MX_TIM1_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(ARD_D5_GPIO_Port, &GPIO_InitStruct);
...
void MX_TIM4_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(ARD_D9_GPIO_Port, &GPIO_InitStruct);
...
void MX_TIM5_Init(void)
{
  ...
  */
  ...
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_2;
  LL_GPIO_Init(ARD_D3_GPIO_Port, &GPIO_InitStruct);
...
void MX_TIM16_Init(void)
{
  ...
  NVIC_SetPriority(TIM16_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),5, 0));
...
void MX_TIM24_Init(void)
{
  ...
  htim24.Init.Prescaler = 549;
  htim24.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim24.Init.Period = 6181;
...
void MX_USART3_UART_Init(void)
{
  ...
  */
  ...
  /* USART3_RX Init */
  LL_DMA_SetPeriphRequest(DMA1, LL_DMA_STREAM_1, LL_DMAMUX1_REQ_USART3_RX);
...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOD, Detectn_Pin|LCD_DISP_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOE, ARD_D8_Pin|STMOD_17_Pin|STMOD_19_Pin|STMOD_18_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOG, LL_GPIO_PIN_13|LCD_BL_CTRL_Pin|ARD_D7_Pin|MEMS_LED_Pin
                          |ARD_D4_Pin|ARD_D2_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOC, USER_LED2_Pin|USER_LED1_Pin);

  /**/
  LL_GPIO_ResetOutputPin(STMOD_20_GPIO_Port, STMOD_20_Pin);

  /**/
  LL_GPIO_ResetOutputPin(GPIOH, LCD_RST_Pin|USB_FS_PWR_EN_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = LL_GPIO_PIN_13|LCD_BL_CTRL_Pin|ARD_D7_Pin|MEMS_LED_Pin
                          |ARD_D4_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  ...
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(Blue_button_B2_used_for_wakeup_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  GPIO_InitStruct.Pin = OCSPI2_CLK_Pin|OCSPI1_CLK_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  ...
  LL_GPIO_Init(ARD_D2_GPIO_Port, &GPIO_InitStruct);
  ...
  LL_GPIO_Init(SPI5_MISO_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  GPIO_InitStruct.Alternate = LL_GPIO_AF_5;
  LL_GPIO_Init(SPI5_MOSI_GPIO_Port, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(STMOD_20_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_SYSCFG_SetEXTISource(LL_SYSCFG_EXTI_PORTH, LL_SYSCFG_EXTI_LINE12);
  ...
  /**/
  LL_GPIO_SetPinPull(uSD_Detect_GPIO_Port, uSD_Detect_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(Audio_Int_GPIO_Port, Audio_Int_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(STMOD_11_INT_GPIO_Port, STMOD_11_INT_Pin, LL_GPIO_PULL_NO);
  ...
  /**/
  LL_GPIO_SetPinMode(Audio_Int_GPIO_Port, Audio_Int_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(STMOD_11_INT_GPIO_Port, STMOD_11_INT_Pin, LL_GPIO_MODE_INPUT);
