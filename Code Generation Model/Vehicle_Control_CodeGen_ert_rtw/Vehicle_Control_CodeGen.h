...
typedef struct {
  real_T MovingAverage;                /* '<S48>/Moving Average' */
} B_MovingAverage_Vehicle_Contr_T;

/* Block states (default storage) for system '<S48>/Moving Average' */
typedef struct {
  dsp_simulink_MovingAverage_Ve_T obj; /* '<S48>/Moving Average' */
...
typedef struct {
  ...
  uint16_T In1;                        /* '<S27>/In1' */
  uint16_T In1_g;                      /* '<S28>/In1' */
  uint16_T In1_g2;                     /* '<S19>/In1' */
  uint16_T In1_g20;                    /* '<S21>/In1' */
  uint16_T In1_g20a;                   /* '<S18>/In1' */
  uint16_T In1_g20as;                  /* '<S22>/In1' */
  uint16_T In1_g20asd;                 /* '<S24>/In1' */
  ...
  B_MovingAverage_Vehicle_Contr_T MovingAverage_p;/* '<S48>/Moving Average' */
  B_MovingAverage_Vehicle_Contr_T MovingAverage;/* '<S48>/Moving Average' */
...
typedef struct {
  ...
  real_T Filter_DSTATE_i;              /* '<S132>/Filter' */
  real_T Integrator_DSTATE_o;          /* '<S137>/Integrator' */
  ...
  real_T TmpRTBAt50HZSendTorqueRequest_c;/* synthesized block */
  real_T TmpRTBAtTriggeredSubsystemInpor;/* synthesized block */
  real_T TmpRTBAtTriggeredSubsystemInp_b;/* synthesized block */
  real_T Memory1_PreviousInput;        /* '<S48>/Memory1' */
  real_T Filter_PREV_U;                /* '<S80>/Filter' */
  real_T Memory1_PreviousInput_a;      /* '<S49>/Memory1' */
  real_T Filter_PREV_U_k;              /* '<S132>/Filter' */
  ...
  volatile uint16_T TmpRTBAtFunctionCallSubsyste_e2;/* synthesized block */
  uint8_T Output_DSTATE;               /* '<S12>/Output' */
  uint8_T Output_DSTATE_a;             /* '<S13>/Output' */
  uint8_T Filter_SYSTEM_ENABLE;        /* '<S80>/Filter' */
  uint8_T Filter_SYSTEM_ENABLE_i;      /* '<S132>/Filter' */
  boolean_T ThrottleRegenControl_RESET_ELAP;/* '<Root>/Throttle//Regen Control' */
  boolean_T Relay_Mode;                /* '<S48>/Relay' */
  boolean_T IC1_FirstOutputTime;       /* '<S48>/IC1' */
  boolean_T Relay_Mode_f;              /* '<S49>/Relay' */
  boolean_T IC2_FirstOutputTime;       /* '<S49>/IC2' */
  ...
  DW_MovingAverage_Vehicle_Cont_T MovingAverage_p;/* '<S48>/Moving Average' */
  DW_MovingAverage_Vehicle_Cont_T MovingAverage;/* '<S48>/Moving Average' */
 ...
 * Block '<S48>/Constant9' : Unused code path elimination
 * Block '<S48>/Product3' : Unused code path elimination
 * Block '<S48>/Saturation1' : Unused code path elimination
 * Block '<S48>/Saturation2' : Unused code path elimination
 * Block '<S48>/Scope' : Unused code path elimination
 * Block '<S48>/Scope1' : Unused code path elimination
 * Block '<S48>/Scope11' : Unused code path elimination
 * Block '<S48>/Scope13' : Unused code path elimination
 * Block '<S48>/Scope14' : Unused code path elimination
 * Block '<S48>/Scope2' : Unused code path elimination
 * Block '<S48>/Scope3' : Unused code path elimination
 * Block '<S48>/Scope5' : Unused code path elimination
 * Block '<S48>/Scope7' : Unused code path elimination
 * Block '<S48>/Scope8' : Unused code path elimination
 * Block '<S48>/Scope9' : Unused code path elimination
 * Block '<S48>/Square' : Unused code path elimination
 * Block '<S48>/Subtract2' : Unused code path elimination
 * Block '<S49>/Scope' : Unused code path elimination
 * Block '<S49>/Scope1' : Unused code path elimination
 * Block '<S49>/Scope10' : Unused code path elimination
 * Block '<S49>/Scope11' : Unused code path elimination
 * Block '<S49>/Scope12' : Unused code path elimination
 * Block '<S49>/Scope13' : Unused code path elimination
 * Block '<S49>/Scope14' : Unused code path elimination
 * Block '<S49>/Scope2' : Unused code path elimination
 * Block '<S49>/Scope3' : Unused code path elimination
 * Block '<S49>/Scope4' : Unused code path elimination
 * Block '<S49>/Scope5' : Unused code path elimination
 * Block '<S49>/Scope6' : Unused code path elimination
 * Block '<S49>/Scope7' : Unused code path elimination
 * Block '<S49>/Scope8' : Unused code path elimination
 * Block '<S49>/Scope9' : Unused code path elimination
 ...
 * '<S9>'   : 'Vehicle_Control_CodeGen/Variant Subsystem'
 * '<S10>'  : 'Vehicle_Control_CodeGen/Variant Subsystem1'
 * '<S11>'  : 'Vehicle_Control_CodeGen/10 HZ Send1/Enabled Subsystem'
 * '<S12>'  : 'Vehicle_Control_CodeGen/10 HZ Send1/Enabled Subsystem/Counter Limited'
 * '<S13>'  : 'Vehicle_Control_CodeGen/10 HZ Send1/Enabled Subsystem/Counter Limited1'
 * '<S14>'  : 'Vehicle_Control_CodeGen/10 HZ Send1/Enabled Subsystem/Counter Limited/Increment Real World'
 * '<S15>'  : 'Vehicle_Control_CodeGen/10 HZ Send1/Enabled Subsystem/Counter Limited/Wrap To Zero'
 * '<S16>'  : 'Vehicle_Control_CodeGen/10 HZ Send1/Enabled Subsystem/Counter Limited1/Increment Real World'
 * '<S17>'  : 'Vehicle_Control_CodeGen/10 HZ Send1/Enabled Subsystem/Counter Limited1/Wrap To Zero'
 * '<S18>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem1'
 * '<S19>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem10'
 * '<S20>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem11'
 * '<S21>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem12'
 * '<S22>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem2'
 * '<S23>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem3'
 * '<S24>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem4'
 * '<S25>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem5'
 * '<S26>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem6'
 * '<S27>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem7'
 * '<S28>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem8'
 * '<S29>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem/If Action Subsystem9'
 * '<S30>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits'
 * '<S31>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits1'
 * '<S32>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits10'
 * '<S33>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits11'
 * '<S34>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits12'
 * '<S35>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits2'
 * '<S36>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits3'
 * '<S37>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits4'
 * '<S38>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits5'
 * '<S39>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits6'
 * '<S40>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits7'
 * '<S41>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits8'
 * '<S42>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Extract Bits9'
 * '<S43>'  : 'Vehicle_Control_CodeGen/Function-Call Subsystem1/Subsystem'
 * '<S44>'  : 'Vehicle_Control_CodeGen/Hardware Interrupt1/ECSoC'
 * '<S45>'  : 'Vehicle_Control_CodeGen/Hardware Interrupt1/ECSoC/ECSimCodegen'
 * '<S46>'  : 'Vehicle_Control_CodeGen/Hardware Interrupt3/ECSoC'
 * '<S47>'  : 'Vehicle_Control_CodeGen/Hardware Interrupt3/ECSoC/ECSimCodegen'
 * '<S48>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1'
 * '<S49>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request'
 * '<S50>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Compare To Constant'
 * '<S51>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1'
 * '<S52>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Anti-windup'
 * '<S53>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/D Gain'
 * '<S54>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/External Derivative'
 * '<S55>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Filter'
 * '<S56>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Filter ICs'
 * '<S57>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/I Gain'
 * '<S58>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Ideal P Gain'
 * '<S59>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Ideal P Gain Fdbk'
 * '<S60>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Integrator'
 * '<S61>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Integrator ICs'
 * '<S62>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/N Copy'
 * '<S63>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/N Gain'
 * '<S64>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/P Copy'
 * '<S65>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Parallel P Gain'
 * '<S66>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Reset Signal'
 * '<S67>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Saturation'
 * '<S68>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Saturation Fdbk'
 * '<S69>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Sum'
 * '<S70>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Sum Fdbk'
 * '<S71>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tracking Mode'
 * '<S72>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tracking Mode Sum'
 * '<S73>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tsamp - Integral'
 * '<S74>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tsamp - Ngain'
 * '<S75>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/postSat Signal'
 * '<S76>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/preSat Signal'
 * '<S77>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Anti-windup/Passthrough'
 * '<S78>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/D Gain/Internal Parameters'
 * '<S79>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/External Derivative/Error'
 * '<S80>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Filter/Disc. Forward Euler Filter'
 * '<S81>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Filter ICs/Internal IC - Filter'
 * '<S82>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/I Gain/Internal Parameters'
 * '<S83>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Ideal P Gain/Passthrough'
 * '<S84>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Ideal P Gain Fdbk/Disabled'
 * '<S85>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Integrator/Discrete'
 * '<S86>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Integrator ICs/Internal IC'
 * '<S87>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/N Copy/Disabled'
 * '<S88>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/N Gain/Internal Parameters'
 * '<S89>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/P Copy/Disabled'
 * '<S90>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Parallel P Gain/Internal Parameters'
 * '<S91>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Reset Signal/Disabled'
 * '<S92>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Saturation/Passthrough'
 * '<S93>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Saturation Fdbk/Disabled'
 * '<S94>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Sum/Sum_PID'
 * '<S95>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Sum Fdbk/Disabled'
 * '<S96>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tracking Mode/Disabled'
 * '<S97>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tracking Mode Sum/Passthrough'
 * '<S98>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tsamp - Integral/TsSignalSpecification'
 * '<S99>'  : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/Tsamp - Ngain/Passthrough'
 * '<S100>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/postSat Signal/Forward_Path'
 * '<S101>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Left Side Torque Request1/Discrete PID Controller1/preSat Signal/Forward_Path'
 * '<S102>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Compare To Constant'
 * '<S103>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1'
 * '<S104>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Anti-windup'
 * '<S105>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/D Gain'
 * '<S106>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/External Derivative'
 * '<S107>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Filter'
 * '<S108>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Filter ICs'
 * '<S109>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/I Gain'
 * '<S110>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Ideal P Gain'
 * '<S111>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Ideal P Gain Fdbk'
 * '<S112>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Integrator'
 * '<S113>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Integrator ICs'
 * '<S114>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/N Copy'
 * '<S115>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/N Gain'
 * '<S116>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/P Copy'
 * '<S117>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Parallel P Gain'
 * '<S118>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Reset Signal'
 * '<S119>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Saturation'
 * '<S120>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Saturation Fdbk'
 * '<S121>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Sum'
 * '<S122>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Sum Fdbk'
 * '<S123>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tracking Mode'
 * '<S124>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tracking Mode Sum'
 * '<S125>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tsamp - Integral'
 * '<S126>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tsamp - Ngain'
 * '<S127>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/postSat Signal'
 * '<S128>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/preSat Signal'
 * '<S129>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Anti-windup/Passthrough'
 * '<S130>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/D Gain/Internal Parameters'
 * '<S131>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/External Derivative/Error'
 * '<S132>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Filter/Disc. Forward Euler Filter'
 * '<S133>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Filter ICs/Internal IC - Filter'
 * '<S134>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/I Gain/Internal Parameters'
 * '<S135>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Ideal P Gain/Passthrough'
 * '<S136>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Ideal P Gain Fdbk/Disabled'
 * '<S137>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Integrator/Discrete'
 * '<S138>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Integrator ICs/Internal IC'
 * '<S139>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/N Copy/Disabled'
 * '<S140>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/N Gain/Internal Parameters'
 * '<S141>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/P Copy/Disabled'
 * '<S142>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Parallel P Gain/Internal Parameters'
 * '<S143>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Reset Signal/Disabled'
 * '<S144>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Saturation/Passthrough'
 * '<S145>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Saturation Fdbk/Disabled'
 * '<S146>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Sum/Sum_PID'
 * '<S147>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Sum Fdbk/Disabled'
 * '<S148>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tracking Mode/Disabled'
 * '<S149>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tracking Mode Sum/Passthrough'
 * '<S150>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tsamp - Integral/TsSignalSpecification'
 * '<S151>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/Tsamp - Ngain/Passthrough'
 * '<S152>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/postSat Signal/Forward_Path'
 * '<S153>' : 'Vehicle_Control_CodeGen/Throttle//Regen Control/Right Side Torque Request/Discrete PID Controller1/preSat Signal/Forward_Path'
 * '<S154>' : 'Vehicle_Control_CodeGen/Variant Subsystem/CAN Forwarding'
 * '<S155>' : 'Vehicle_Control_CodeGen/Variant Subsystem1/CAN Forwarding'
 */
